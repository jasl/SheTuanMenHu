(function() {
    CKEDITOR.dialog.add('attachment', function(editor) {
        ...
        return{title:editor.lang.attachment.title,minWidth:420,minHeight:200,onShow:function() {
            ...
            //var attributes = {href: element.getAttribute('_cke_saved_href')+'/*' + CKEDITOR.tools.getNextNumber() + '*/'},removeAttributes = [],data = {href:attributes.href},me = this,editor = this.getParentEditor();
            ...
            attributes.href = (url.indexOf('/') === 0) ? url : "http://" + url; //patch!!!!
            if (data.target) {
